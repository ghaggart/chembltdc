...
# Code taken from: https://github.com/kzfm/pychembldb/blob/master/pychembldb/__init__.py
...
class TargetDictionary(Base):
    ...
    components = relationship('ComponentSequence', secondary=Table('target_components', metadata, autoload=True),
                              backref='target')
    ...
    molecules = relationship('MoleculeDictionary', secondary=Table('drug_mechanism', metadata, autoload=True),
                             backref='targets')
    compounds = relationship('CompoundRecord', secondary=Table('drug_mechanism', metadata, autoload=True),
                             backref='targets')
...
class ComponentSequence(Base):
    ...
    classes = relationship('ProteinClassification', secondary=Table('component_class', metadata, autoload=True),
                           backref='component')
    ...
    targets = relationship('TargetDictionary', secondary=Table('target_components', metadata, autoload=True),
                           backref='component')
    domains = relationship('Domain', secondary=Table('component_domains', metadata, autoload=True), backref='component')
    binding_sites = relationship('BindingSite', secondary=Table('site_components', metadata, autoload=True),
                                 backref='component')


class ProteinClassification(Base):
    __table__ = Table('protein_classification', metadata, autoload=True)
    components = relationship('ComponentSequence', secondary=Table('component_class', metadata, autoload=True),
                              backref='family')
...
class GOClassification(Base):
    ...
    components = relationship('ComponentSequence', secondary=Table('component_go', metadata, autoload=True),
                              backref='gos')
...
class BindingSite(Base):
    ...
    domains = relationship('Domain', secondary=Table('site_components', metadata, autoload=True),
                           backref='binding_sites')
    components = relationship('ComponentSequence', secondary=Table('site_components', metadata, autoload=True),
                              backref='bindingsites')
...
class Domain(Base):
    ...
    components = relationship('ComponentSequence', secondary=Table('component_domains', metadata, autoload=True),
                              backref='domain')
...
class Product(Base):
    ...
    molecules = relationship('MoleculeDictionary', secondary=Table('formulations', metadata, autoload=True),
                             backref='mol_products')
...
class AtcClassification(Base):
    ...
    molecules = relationship('MoleculeDictionary',
                             secondary=Table('molecule_atc_classification', metadata, autoload=True), backref='atcs')
...
class MoleculeDictionary(Base):
    ...
    atc_classifications = relationship('AtcClassification',
                                       secondary=Table('molecule_atc_classification', metadata, autoload=True),
                                       backref='atc_molecules')
    products = relationship('MoleculeDictionary', secondary=Table('formulations', metadata, autoload=True),
                            backref='product_molecules')
...
class Biotherapeutics(Base):
    ...
    components = relationship('BioComponentSequence',
                              secondary=Table('biotherapeutic_components', metadata, autoload=True),
                              backref='biotherapeutics')


class BioComponentSequence(Base):
    __table__ = Table('bio_component_sequences', metadata, autoload=True)
    therapeutics = relationship('Biotherapeutics',
                                secondary=Table('biotherapeutic_components', metadata, autoload=True),
                                backref='component')
...
class StructuralAlert(Base):
    ...
    molecules = relationship('MoleculeDictionary',
                             secondary=Table('compound_structural_alerts', metadata, autoload=True), backref='alerts')
